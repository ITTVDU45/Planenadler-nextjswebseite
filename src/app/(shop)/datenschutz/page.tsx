...
export const metadata: Metadata = {
  title: 'Datenschutzerklärung | Planenadler',
  description:
    'Datenschutzerklärung – Informationen zur Erhebung und Verarbeitung personenbezogener Daten auf der Website von Planenadler.',
  openGraph: {
    title: 'Datenschutzerklärung | Planenadler',
...
export default function DatenschutzPage() {
  return (
    <main className="min-h-screen bg-white pb-24 sm:pt-20 lg:pb-16">
      <TopBar />
      <article className="py-12" aria-label="Datenschutzerklärung">
        <ContentShell className="max-w-3xl">
          ...
          <div className="mt-8 space-y-4 text-[#1F5CAB]/90 text-sm leading-relaxed">
            ...
            <section className={sectionClass}>
              <h2 className={h2Class}>1. Datenschutz auf einen Blick</h2>

              <h3 className={h3Class}>Allgemeine Hinweise</h3>
              <p>
              ...
              <h3 className={h3Class}>Datenerfassung auf dieser Website</h3>
              <p>
            ...
            <section className={sectionClass}>
              ...
              <p>
                ...
                verarbeitet werden. Im Falle einer ausdrücklichen Einwilligung in
                die Übertragung personenbezogener Daten in Drittstaaten erfolgt
                die Datenverarbeitung außerdem auf Grundlage von Art. 49 Abs. 1
                lit. a DSGVO. Sofern Sie in die Speicherung von Cookies oder in
                den Zugriff auf Informationen in Ihr Endgerät (z. B. via
            ...
            <section className={sectionClass}>
              ...
              <p>
                ...
                Drittunternehmen stammen (sog. Third-Party-Cookies). Third-Party-
                Cookies ermöglichen die Einbindung bestimmter Dienstleistungen von
              ...
              <p>
                ...
                an der effektiven Bearbeitung der an uns gerichteten Anfragen (Art.
                6 Abs. 1 lit. f DSGVO) oder auf Ihrer Einwilligung (Art. 6 Abs. 1
            ...
            <section className={sectionClass}>
              ...
              <h3 className={h3Class}>Google Fonts (lokales Hosting)</h3>
              <p>
                ...
                Servern von Google findet dabei nicht statt. Weitere
              ...
              <h3 className={h3Class}>Google Maps</h3>
              <p>
                Diese Seite nutzt den Kartendienst Google Maps. Anbieter ist die
                Google Ireland Limited („Google“), Gordon House, Barrow Street,
                Dublin 4, Irland. Mit Hilfe dieses Dienstes können wir Kartenmaterial
                auf unserer Website einbinden. Zur Nutzung der Funktionen von
                ...
                aktiviert ist, kann Google zum Zwecke der einheitlichen Darstellung
                der Schriftarten Google Fonts verwenden. Beim Aufruf von Google
                Maps lädt Ihr Browser die benötigten Web Fonts in ihren Browsercache,
            ...
            <p className="mt-8 text-[#1F5CAB]/70">
              Quelle:{' '}
              <a
