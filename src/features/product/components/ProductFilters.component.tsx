...
const ProductFilters = ({
  ...
  // Get unique sizes from all products (from allPaSizes or variation attributes)
  const sizes = Array.from(
    new Set(products.flatMap((product: Product) => getSizesFromProduct(product))),
  ).sort((a, b) => a.localeCompare(b));

  // Get unique colors from all products (from allPaColors or variation attributes)
