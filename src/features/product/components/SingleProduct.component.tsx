...
// Types
import type { ISingleProductProps, ISingleProduct } from '@/shared/types/product';

/** Format a price string: padding + HTML-Entitäten für Anzeige decodieren */
const formatPrice = (value: string | undefined): string | undefined => {
  if (!value) return value;
  return decodePriceDisplay(paddedPrice(value, 'kr'));
};
...
/** Resolve the product image source URL (absolute for next/image) */
