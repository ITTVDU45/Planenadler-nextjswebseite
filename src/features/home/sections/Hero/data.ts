...
export const HERO_SLIDES: HeroSlide[] = [
  ...
  },
  {
    ...
    background: {
      src: '/images/anhängerflachplane.png',
      alt: 'Anhängerplane',
    },
    thumbMain: {
      src: '/images/anhängerflachplane.png',
  ...
  },
  {
    ...
    background: {
      src: '/images/Abdeckplane_Holz.png',
      alt: 'Abdeckplane fuer Holz und Material',
    },
    thumbMain: {
      src: '/images/Abdeckplane_Holz.png',
      alt: 'Abdeckplane fuer Holz und Material',
  ...
  },
  {
    ...
    background: {
      src: '/images/Adlerplanen_Poolabdeckung.png',
      alt: 'Maßgefertigte Poolabdeckung von Planenadler',
    },
    thumbMain: {
      src: '/images/Adlerplanen_Poolabdeckung.png',
      alt: 'Maßgefertigte Poolabdeckung von Planenadler',
